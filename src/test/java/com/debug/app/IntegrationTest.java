...
import com.debug.app.DebugappApp;
import com.debug.app.config.AsyncSyncConfiguration;
import com.debug.app.config.EmbeddedSQL;
...
@SpringBootTest(classes = { DebugappApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
