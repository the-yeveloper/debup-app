...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.debug.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.debug.app.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
